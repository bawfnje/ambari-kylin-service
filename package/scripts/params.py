...
kylin_project_name = 'apache-kylin-2.6.6-bin-hadoop3'
...
kylin_download = format('cat /etc/yum.repos.d/ambari.repo | grep "baseurl" |grep "ambari" | awk -F \'=\' \'{print $2"/kylin/apache-kylin-2.6.6-bin-hadoop3.tar.gz"}\'')
...
spark_download_base_url = config['configurations']['kylin-spark-download']['spark_download_base_url']
